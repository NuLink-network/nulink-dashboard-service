...
public class StakeRewardDTO extends BaseDto {
    ...
    public String getCurrentFeeRatio() {
        return currentFeeRatio;
    }

    public void setCurrentFeeRatio(String currentFeeRatio) {
        this.currentFeeRatio = currentFeeRatio;
    }

    public String getNextFeeRatio() {
        return nextFeeRatio;
    }

    public void setNextFeeRatio(String nextFeeRatio) {
        this.nextFeeRatio = nextFeeRatio;
    }
}
